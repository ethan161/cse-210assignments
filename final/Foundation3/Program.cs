...
class Program
{
    ...
    public List<Event> CreateEvents()
    {
        ...
        Lecture lecture = new Lecture("Teacher Convention", "01/01/2024", "07:00pm", "A lecture about how to become a more caring teachers", new Address("32nd Street", "Toronto", "Ontario", "Canada"), "Jake Nacho", 250);
